...
function useTilt(ref) {
  useEffect(() => {
    ...
    const leave = () => { el.style.transform = "perspective(700px) rotateY(0) rotateX(0) translateZ(0)"; };
...
function MemberCard({ member }) {
  ...
  return (
    ...
    >
      ...
      {/* Punch line */}
      <p className="text-xs italic mb-3 max-w-[200px] leading-relaxed"
...
function Team() {
  ...
  const excom = [
    ...
    { name: "Chandana S",     role: "Treasurer",           img: chandana, punch: "Managing resources with transparency and responsibility." },
  ...
  return (
    <section className="pt-8 pb-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* ExCom */}
        <div className="team-sr section-reveal mb-20">
          <SectionHeading
        ...
        <hr className="wie-divider mb-20" />

        {/* Team */}
        <div className="team-sr section-reveal mb-20" style={{ transitionDelay: "0.1s" }}>
          <SectionHeading
            title="WIE Team 2026"
        ...
        {/* Faculty */}
        <div className="team-sr section-reveal" style={{ transitionDelay: "0.2s" }}>
          <SectionHeading
